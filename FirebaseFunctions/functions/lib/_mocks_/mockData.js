...
export const testPrayerNew = {
    id: 'test-prayer-id-1',
    title: "Test Prayer",
    description: "This is a test prayer.",
    dummy: true,
};
export const testPrayer = {
    id: 'test-prayer-id-2',
    title: "Test Prayer",
    description: "This is a test prayer.",
...
export const testPrayerPointNew = {
